...
- [Document formats](experiments/doc-format/README.md) — what a paper and two code reviews cost Claude Code to read as PDF, HTML, Markdown and a claude.ai artifact link.
- [ultratoken](experiments/ultratoken/README.md) — a keyword that sent each job in a prompt to its own model and effort, and why it did not ship.
